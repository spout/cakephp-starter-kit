...
<?php echo $this->Form->input('email', array('label' => __('Votre e-mail'), 'size' => 45));?>
<?php echo $this->Form->input('subject', array('label' => __('Sujet'), 'size' => 45, 'default' => isset($_GET['subject']) ? $_GET['subject'] : ''));?>
